...
let i = 1;
export default {
  name: "datagridview.vue",
  data() {
    return {
      headers: [
        {value: "editable", text: "editable", align: "center", width: "50px", changeAble: false},
        {value: "division", text: "division", align: "center", width: "50px", changeAble: false},
        {value: "id", text: "id", align: "center", width: "50px", changeAble: false},
        {value: "name", text: "name", align: "center", width: "50px", changeAble: true},
        {value: "number", text: "number", align: "center", width: "50px", changeAble: true},
        {value: "position", text: "position", align: "center", width: "50px", changeAble: true},
        {value: "edits", text: "edits", align: "center", width: "50px", changeAble: false},
      ],
      rows: [],
